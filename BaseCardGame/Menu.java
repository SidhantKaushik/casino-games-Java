...
public class Menu 
{
	...
	private MenuOption a = new MenuOption('A', "Punta Banco");
	private MenuOption b = new MenuOption('B', "Hi-Low");
	private MenuOption c = new MenuOption('C', "Exit");
	/**
	 * Default Constructor
	 */
